...
function Korzina() {
  ...
  return (
    <div className="bigKorzina">
          ...
          <div className="korzina-cart-products">
            ...
            <div className="korzina-cont-products-all">
              {korzinaProduct.map((korzin, i) => {
                return (
                  <div key={korzin.id} className="korzina-cart-product">
                    ...
                    <p className="total">${korzin.price * korzin.qty}</p>
                  </div>
                );
              })}
            </div>
      ...
      <div className="order">
        {modal && <Order total={total} setModal={setModal} />}
      </div>
      {modal && <div onClick={modalClose} className="modal"></div>}
      <Footer />
    </div>
  );
}
